...
public class StorageServiceServerTest
{
    ...
    class MultiDCSnitch implements IEndpointSnitch {

        private Map<InetAddress, String> endpointToDc;

        public MultiDCSnitch(Map<InetAddress, String> endpointToDc) {
        ...
        public String getDatacenter(InetAddress endpoint) {
            return endpointToDc.get(endpoint);
        }
        ...
        @Override
        public void sortByProximity(InetAddress address,
